...
|Variable name|Description|Reasoning / Filtering (see Coding / Classification system)|Format / Coding / Classification system|Available? (Y/N) / Comments|
|:----|:----|:----|:----|:----|
...
|No filtering|A unique identifier for each individual patient across the dataset|Y|
...
|Derived from NHS Data Model POSTCODE OF USUAL ADDRESS|
|Y|
|gender|Defines the sex of the patient|To report on patient demographics.|
|No filtering|NHS Data Model PERSON GENDER CODE|
|Y|
...
|on or before 2022-09-30|NHS Data Model START DATE (HOSPITAL PROVIDER SPELL)|
| |Y|
...
|No filtering|NHS Data Model START TIME (HOSPITAL PROVIDER SPELL)|
|Y|
|disdest|Identifies where the patient was due to go on leaving hospital|Can be used to identify discharge to care homes.|
|No filtering|NHS Data Model DISCHARGE DESTINATION CODE (HOSPITAL PROVIDER SPELL|
|Y|
|dismeth|Indicates the circumstances under which a patient left hospital|Used to identify deaths.|
|No filtering|NHS Data Model DISCHARGE METHOD CODE (HOSPITAL PROVIDER SPELL)|
|Y|
...
|NHS Data Model START DATE (HOSPITAL PROVIDER SPELL)|
|and|
|NHS Data Model DISCHARGE DATE (HOSPITAL PROVIDER SPELL)|
|Y|
...
|admiage equals or is greater than 18 years old|NHS Data Model AGE ON ADMISSION|
|Y|
...
|No filtering|NHS Data Model PRIMARY DIAGNOSIS (ICD)|
|Code required to be in contemporary ICD-10 coding standard.|Y|
...
|May include up to 19 secondary diagnosis fields, from 02-20.|NHS Data Model SECONDARY DIAGNOSIS (ICD)|
|Code required to be in contemporary ICD-10 coding standard.|Y|
|opertn_01|The main operative procedure code recorded for the episode. The classification system in use is OPCS-4.| See epiorder. No filtering|NHS Data Model PRIMARY PROCEDURE (OPCS)|
|Codes required to be in contemporary OPCS-4 coding standard|Y|
...
|May include up to 23 secondary procedure fields, from 02-24.|NHS Data Model PROCEDURE (OPCS)|
|Codes required to be in contemporary OPCS-4 coding standard|Y|
...
|Y|
|gender|Defines the sex of the patient|To report on patient demographics.|
|No filtering|NHS Data Model PERSON STATED GENDER CODE|
|Y|
|ethnos|The ethnicity of the patient, as specified by the patient. Groups as defined in the 2001 census.|To report on patient demographics.|
|No filtering|NHS Data Model ETHNIC CATEGORY|
|Y|
...
|No filtering|NHS Data Model ACCOMMODATION STATUS (SNOMED CT)|
|Y but will require conversion|
|procodet|NHS Digital ODS code defining the organisation providing treatment.|To be able to identify the trust of the admission|NHS Data Model ORGANISATION IDENTIFIER (CODE OF PROVIDER)|
|Y|
...
|(eddepttype = 01)|NHS Data Model EMERGENCY CARE DEPARTMENT TYPE|
|Y|
...
|No filtering|NHS Data Model EMERGENCY CARE ARRIVAL MODE (SNOMED CT)|
|Y|
...
|(edattendcat = 1)|NHS Data Model EMERGENCY CARE ATTENDANCE CATEGORY|
|Y|
|edattendsource|The source of an Emergency Care Attendance|Used to identify the source of an attendance (e.g. via a GP)|
|No filtering|NHS Data Model EMERGENCY CARE ATTENDANCE SOURCE (SNOMED CT)|
|Y|
...
|Timezone will be required to derive time in ED correctly.|Derived from NHS Data Model EMERGENCY CARE ARRIVAL DATE|
|and|
|NHS Data Model EMERGENCY CARE ARRIVAL TIME|
|Y|
|activage|
| |Age at time of activity|To report on patient demographics and to limit to desired cohort.|
|admiage equals or is greater than 18 years old|NHS Data Model AGE AT CDS ACTIVITY DATE|
|Y|
|edacuity|Acuity of patient’s condition at time of initial assessment.|
|SNOMED code.|To report on patient demographics.|
|No filtering|NHS Data Model EMERGENCY CARE ACUITY (SNOMED CT)|
|Y. Probably|
|edcheifcomplaint|Chief complaint as assessed by the care professional first assessing the patient.|
|SNOMED code.|To report on patient demographics.|
|No filtering|NHS Data Model EMERGENCY CARE CHIEF COMPLAINT (SNOMED CT)|
|Likely to be poorly recorded (lots of free text) and may not be codified|
|edcomorb_NN|Comorbidities identified for the patient.|
|SNOMED code.|Used to identify comorbid conditions|
|May include up to 10 fields, from 01-10|NHS Data Model COMORBIDITY (SNOMED CT)|
|Y but in ICD10 – will require conversion|
...
|May include up to 12 fields, from 01-12|NHS Data Model EMERGENCY CARE DIAGNOSIS (SNOMED CT)|
|Y but in ICD10 – will require conversion|
...
|May include up to 2 fields, from 01-12|NHS Data Model CODED CLINICAL ENTRY SEQUENCE NUMBER|
|Y|
...
|May include up to 12 fields, from 01-12|NHS Data Model EMERGENCY CARE DIAGNOSIS QUALIFIER (SNOMED CT)|
|Possibly but may be in free-text|
...
|May include up to 12 fields, from 01-12|NHS Data Model EMERGENCY CARE CLINICAL INVESTIGATION (SNOMED CT)|
|Y but in ICD10 – will require conversion|
...
|May include up to 12 fields, from 01-12|NHS Data Model EMERGENCY CARE PROCEDURE (SNOMED CT)|
|Possibly but may be in free-text|
|timeined|The time a patient spent in ED (in minutes)|Used to report on time in ED|
|See edarrivaldatetime for filtering.|
|Also, timezone will need to be considered to correctly derive field around daylight saving transition (BST/GMT)|Derived from NHS Data Model EMERGENCY CARE DEPARTURE DATE|
|andNHS Data Model EMERGENCY CARE DEPARTURE TIME|
|and|
|edarrivaldatetime|Y|
...
|No filtering|NHS Data Model EMERGENCY CARE DISCHARGE DESTINATION (SNOMED CT)|
| |Y but incomplete and will require conversion|
...
|No filtering|NHS Data Model REFERRED TO SERVICE (SNOMED CT)|
|Quite a lot of missing data but present for >50%|
